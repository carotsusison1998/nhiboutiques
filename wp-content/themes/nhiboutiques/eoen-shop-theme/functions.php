...
if (!class_exists('Excellent_Plus_Features')) {
	class Excellent_Customize_upgrade extends WP_Customize_Control {
		public function render_content() { ?>
			<a title="<?php esc_attr_e( 'Review Us', 'excellent' ); ?>" href="<?php echo esc_url( 'https://wordpress.org/support/view/theme-reviews/excellent/' ); ?>" target="_blank" id="about_excellent">
			<?php esc_html_e( 'Review Us', 'excellent' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://themefreesia.com/theme-instruction/excellent/' ); ?>" title="<?php esc_attr_e( 'Theme Instructions', 'excellent' ); ?>" target="_blank" id="about_excellent">
			<?php esc_html_e( 'Theme Instructions', 'excellent' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://tickets.themefreesia.com/' ); ?>" title="<?php esc_attr_e( 'Support Tickets', 'excellent' ); ?>" target="_blank" id="about_excellent">
			<?php esc_html_e( 'Forum', 'excellent' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://www.facebook.com/themefreesia/' ); ?>" title="<?php esc_attr_e( 'Facebook', 'excellent' ); ?>" target="_blank" id="about_excellent">
			<?php esc_html_e( 'Facebook', 'excellent' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://twitter.com/themefreesia' ); ?>" title="<?php esc_attr_e( 'Twitter', 'excellent' ); ?>" target="_blank" id="about_excellent">
