  ...
  (global = global || self, global.common = factory());
    ...
    var common = {
        ...
        */
        ...
        recruitItemHeight: function(){
          if ($('.home .recruit .item .header.mobile').length <=0 || $('.home .recruit .item .header.pc').length <=0) {
            return;
          }
          Libs.setContentHeight({
            elem: '.home .recruit .item .header.mobile',
            breakLine: 300,
            minBreakLine: 300
          }); 
          Libs.setContentHeight({
            elem: '.home .recruit .item .header.pc',
            breakLine: 300,
            minBreakLine: 300
          });
        },
