	...
	<article id="post-<?php the_ID(); ?>" <?php post_class();?>>
		...
		<?php  $entry_format_meta_blog = $excellent_settings['excellent_entry_meta_blog'];
			...
			<?php if($entry_format_meta_blog == 'show-meta' ){ ?> 
				<div class="entry-meta">
					<span class="author vcard"><span><?php esc_html_e('by','excellent');?></span><a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) )); ?>" title="<?php the_author(); ?>">
			...
			if($content_display == 'excerptblog_display'):
					the_excerpt(); ?>
				<a href="<?php echo esc_url(get_permalink());?>" class="more-link"><?php echo esc_html($excellent_tag_text);?></a>
				<?php else:
